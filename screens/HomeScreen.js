            ...
            <SafeAreaView className="flex flex-1">
              ...
              <View style={{height: '5%'}} className="mx-4 relative z-50">
                <View 
                  ...
                  style={{backgroundColor: showSearch? theme.bgBlue(0.2): 'transparent'}}>
                    ...
                    <TouchableOpacity 
                      ...
                      style={{backgroundColor: theme.bgBlue(0.3)}}>
                      {
                        showSearch? (
              ...
              <View className="mb-2 space-y-3">
                <View className="flex-row items-center mx-5 space-x-2">
                  ...
                  <Text className="text-white text-base">Forcast Of Next Seven Days</Text>
                </View>
                <ScrollView   
                  horizontal
